...
* Ввести в поле "Год" значение меньше текущего года и до значения до +5 лет от текущего года
...
*ОР:* Появляется надпись "Неверный формат" рядом с полем
...
18. Ввод букв, спецсимволов
* Ввести буквы
* Ввести спецсимволы

*ОР:* Ввод невозможен

19. Ввод значение года менее текущего
...
20. Ввод значения года больше текущего
...
22. Ввод данных в значение поля на кириллице
